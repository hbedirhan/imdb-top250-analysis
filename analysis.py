...
# plt.xlabel('imdb puanları')
# plt.ylabel('Film Sayıları')
# plt.title('imdb puanına göre top 250')
# plt.show()
...
# plt.title("Filmlerin çıkış tarihine göre imdb top 250")
...
# plt.bar(mean1, year1, color='r', label="2001-2010 arası imdb puan ortalaması", width=0.01)
# plt.bar(mean2, year2, color='y', label="1991-2000 arası imdb puan ortalaması",width=0.01)
# plt.legend()
# plt.xlabel('imdb puanları')
# plt.ylabel('Film Sayıları')
# plt.title("Yıllara göre imdb puan ortalamalarının karşılaştırması")
# # plt.show()

max80s = df[(df['Year'] >= 1980) & (df['Year'] < 1990)].median()
